...
class Ui_HexapodController(object):
    def setupUi(self, HexapodController):
        if not HexapodController.objectName():
            HexapodController.setObjectName("HexapodController")
        HexapodController.resize(900, 800)
        icon = QIcon()
        iconThemeName = "battery"
        ...
        self.transition_status_title.setObjectName("transition_status_title")

        self.horizontalLayout_8.addWidget(self.transition_status_title)

        self.transition_status_label = QLabel(self.Init)
        self.transition_status_label.setObjectName("transition_status_label")
        ...
        self.init_transition_button.setObjectName("init_transition_button")
        ...
        self.idle_transition_button.setObjectName("idle_transition_button")
        ...
        self.walk_transition_button.setObjectName("walk_transition_button")
        ...
        self.velocity_control_widget.setObjectName("velocity_control_widget")
        ...
        self.vdir_dial.setObjectName("vdir_dial")
        ...
        self.vdir_spinbox.setObjectName("vdir_spinbox")
        ...
        self.vval_widget.setObjectName("vval_widget")
        ...
        self.velocity_value_title.setObjectName("velocity_value_title")
        ...
        self.vval_slider.setObjectName("vval_slider")
        ...
        self.vval_spinbox.setObjectName("vval_spinbox")
        ...
        self.vval_stop_button.setObjectName("vval_stop_button")
        ...
        self.angular_vel_widget.setObjectName("angular_vel_widget")
        self.angular_vel_widget.setAutoFillBackground(True)
        self.angular_velocity = QVBoxLayout(self.angular_vel_widget)
        self.angular_velocity.setObjectName("angular_velocity")
        self.angular_vel_title = QLabel(self.angular_vel_widget)
        self.angular_vel_title.setObjectName("angular_vel_title")
        ...
        self.angular_vel_slider.setObjectName("angular_vel_slider")
        ...
        self.angular_vel_spinbox.setObjectName("angular_vel_spinbox")
        ...
        self.angular_vel_stopbutton.setObjectName("angular_vel_stopbutton")
        ...
        self.battery_lvl_widget_2.setObjectName("battery_lvl_widget_2")
        ...
        self.gait_type_widget_2.setObjectName("gait_type_widget_2")
        ...
        self.gait_selection.setObjectName("gait_selection")
        ...
        self.roll_reset_button.setObjectName("roll_reset_button")
        ...
        self.pitch_reset_button.setObjectName("pitch_reset_button")
        ...
        self.base_height_slider.setObjectName("base_height_slider")
        ...
        self.base_height_default_button.setObjectName("base_height_default_button")
