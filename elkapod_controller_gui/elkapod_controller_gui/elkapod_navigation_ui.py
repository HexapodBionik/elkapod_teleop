...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        Form.setFont(font)
        Form.setStyleSheet(u"background-color: rgb(42, 42, 42);")
        ...
        self.Navigation.setAlignment(Qt.AlignmentFlag.AlignLeading|Qt.AlignmentFlag.AlignLeft|Qt.AlignmentFlag.AlignTop)

        self.verticalLayout.addWidget(self.Navigation)

        self.slamWidget_2 = QWidget(Form)
        self.slamWidget_2.setObjectName(u"slamWidget_2")
        sizePolicy1.setHeightForWidth(self.slamWidget_2.sizePolicy().hasHeightForWidth())
        self.slamWidget_2.setSizePolicy(sizePolicy1)
        self.slamWidget_2.setMinimumSize(QSize(450, 150))
        self.slamWidget_2.setStyleSheet(u"background-color: rgb(82, 81, 81);")
        self.slamWidget = QHBoxLayout(self.slamWidget_2)
        self.slamWidget.setSpacing(0)
        self.slamWidget.setObjectName(u"slamWidget")
        ...
        self.slamInfo.setObjectName(u"slamInfo")
        self.slam = QLabel(self.slamWidget_2)
        self.slam.setObjectName(u"slam")
        ...
        self.slamStatusBox.setObjectName(u"slamStatusBox")
        sizePolicy2.setHeightForWidth(self.slamStatusBox.sizePolicy().hasHeightForWidth())
        ...
        self.status.setAlignment(Qt.AlignmentFlag.AlignLeading|Qt.AlignmentFlag.AlignLeft|Qt.AlignmentFlag.AlignTop)

        self.horizontalLayout_3.addWidget(self.status)

        self.slam_status = QLabel(self.slamStatusBox)
        self.slam_status.setObjectName(u"slamStatus")
        sizePolicy1.setHeightForWidth(self.slam_status.sizePolicy().hasHeightForWidth())
        self.slam_status.setSizePolicy(sizePolicy1)
        self.slam_status.setAlignment(Qt.AlignmentFlag.AlignLeading | Qt.AlignmentFlag.AlignLeft | Qt.AlignmentFlag.AlignTop)
        ...
        self.slamControls.setObjectName(u"slamControls")
        ...
        self.slam_mode_combo.setObjectName(u"slamModeCombo")
        sizePolicy3 = QSizePolicy(QSizePolicy.Policy.Preferred, QSizePolicy.Policy.Fixed)
        sizePolicy3.setHorizontalStretch(0)
        sizePolicy3.setVerticalStretch(0)
        sizePolicy3.setHeightForWidth(self.slam_mode_combo.sizePolicy().hasHeightForWidth())
        ...
        self.odomWidget_2.setObjectName(u"odomWidget_2")
        sizePolicy1.setHeightForWidth(self.odomWidget_2.sizePolicy().hasHeightForWidth())
        self.odomWidget_2.setSizePolicy(sizePolicy1)
        self.odomWidget_2.setMinimumSize(QSize(450, 150))
        self.odomWidget_2.setStyleSheet(u"background-color: rgb(82, 81, 81);")
        self.odomWidget = QHBoxLayout(self.odomWidget_2)
        self.odomWidget.setSpacing(0)
        self.odomWidget.setObjectName(u"odomWidget")
        ...
        self.odomInfo.setObjectName(u"odomInfo")
        self.odometry = QLabel(self.odomWidget_2)
        self.odometry.setObjectName(u"odometry")
        ...
        self.status_2.setAlignment(Qt.AlignmentFlag.AlignLeading|Qt.AlignmentFlag.AlignLeft|Qt.AlignmentFlag.AlignTop)

        self.horizontalLayout_4.addWidget(self.status_2)

        self.odom_status = QLabel(self.horizontalWidget_4)
        self.odom_status.setObjectName(u"odomStatus")
        sizePolicy1.setHeightForWidth(self.odom_status.sizePolicy().hasHeightForWidth())
        self.odom_status.setSizePolicy(sizePolicy1)
        self.odom_status.setAlignment(Qt.AlignmentFlag.AlignLeading | Qt.AlignmentFlag.AlignLeft | Qt.AlignmentFlag.AlignTop)
        ...
        self.odomControls.setObjectName(u"odomControls")
        self.odomControls.setContentsMargins(-1, 10, -1, 10)
        self.odomStats = QLabel(self.odomWidget_2)
        self.odomStats.setObjectName(u"odomStats")
    ...
    def retranslateUi(self, Form):
        ...
        self.Navigation.setText(QCoreApplication.translate("Form", u"Navigation", None))
        self.slam.setText(QCoreApplication.translate("Form", u"SLAM", None))
        self.status.setText(QCoreApplication.translate("Form", u"Status", None))
        self.slam_status.setText(QCoreApplication.translate("Form", u"TextLabel", None))
        self.mode.setText(QCoreApplication.translate("Form", u"Mode:", None))
        self.slam_resume.setText(QCoreApplication.translate("Form", u"Resume", None))
        self.slam_pause.setText(QCoreApplication.translate("Form", u"Pause", None))
        self.slam_restart.setText(QCoreApplication.translate("Form", u"Restart", None))
        self.odometry.setText(QCoreApplication.translate("Form", u"Odometry", None))
        self.status_2.setText(QCoreApplication.translate("Form", u"Status", None))
        self.odom_status.setText(QCoreApplication.translate("Form", u"TextLabel", None))
        self.odomStats.setText(QCoreApplication.translate("Form", u"TextLabel", None))
        self.odom_resume.setText(QCoreApplication.translate("Form", u"Resume", None))
        self.odom_pause.setText(QCoreApplication.translate("Form", u"Pause", None))
        self.odom_restart.setText(QCoreApplication.translate("Form", u"Restart", None))
    # retranslateUi
